...
public interface PcapHandler<T> {
     ...
     *
     * @param user     user supplied object to dispatch or loop calls
     * @param seconds  timestamp
     * @param useconds timestamp
     * @param caplen   amount of data captured
     * @param len      original packet length as seen on the network
     * @param buffer   buffer containing the packet data.
     */
