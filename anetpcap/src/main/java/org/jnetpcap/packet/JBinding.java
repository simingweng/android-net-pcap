...
public interface JBinding extends JDependency {
    ...
    public static abstract class DefaultJBinding implements JBinding {
         ...
         *
         * @param myId          ID of the header that owns this binding
         * @param targetId      ID of the header to which this binding needs to be applied to.
         *                      The target ID also becomes an automatic dependency since that is
         *                      always the case.
         * @param dependencyIds additional IDs of headers that are referenced in the binding
         *                      expression
         */
     ...
     *
     * @param packet packet and its data buffer
     * @param offset offset into the packet data buffer where the end of the previous
     *               header is
