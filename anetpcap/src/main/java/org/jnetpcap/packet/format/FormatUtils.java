...
public class FormatUtils {
     ...
     *
     * @param array     array to convert
     * @param separator separator character to use in between array elements
     * @return the converted string
     */
     ...
     * @param array     array to convert
     * @param separator separator character to use in between array elements
     * @param radix     numerical radix to use for numbers
     * @return the converted string
     */
     ...
     * @param holes if true holes are allowed
     ...
     *
     * @param millis delta timestamp in millis
     * @return formatted string
     */
     ...
     *
     * @param array         array to convert
     * @param addressOffset offset of the address space reported
     * @param dataOffset    offset of the data space reported
     * @param doAddress     flag which specifies if address should be printed
     * @param doText        flag which specifies if text should printed
     * @param doData        flag which specifies if data should printed
