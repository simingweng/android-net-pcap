...
public class XmlFormatter extends JFormatter {
     ...
     * @see JFormatter#fieldAfter(org.jnetpcap.packet.JHeader, org.jnetpcap.packet.structure.JField, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#fieldBefore(org.jnetpcap.packet.JHeader, org.jnetpcap.packet.structure.JField, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#headerAfter(org.jnetpcap.packet.JHeader, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#headerBefore(org.jnetpcap.packet.JHeader, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#packetAfter(org.jnetpcap.packet.JPacket, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#packetBefore(org.jnetpcap.packet.JPacket, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#subHeaderAfter(org.jnetpcap.packet.JHeader, org.jnetpcap.packet.JHeader, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
     ...
     * @param detail
     * @throws java.io.IOException
     * @see JFormatter#subHeaderBefore(org.jnetpcap.packet.JHeader, org.jnetpcap.packet.JHeader, org.jnetpcap.packet.format.JFormatter.Detail)
     */
    @Override
