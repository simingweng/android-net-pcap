...
public abstract class JFormatter {
     ...
     * Sets the default.
     *
     * @param formatter the new default
     */
     ...
     *
     * @param enable true will enable display of payload header otherwise disable
     ...
     *
     * @param enable the new default resolve address
     */
     ...
     * Creates a formatter.
     *
     * @param out appendable device where to send output
     */
     ...
     * Creates a formatter.
     *
     * @param out buffer where to send output
     */
     ...
     * @throws java.io.IOException any IO errors when sending data to default output device
     */
     ...
     * Formats a packet for output.
     *
     * @param out    string buffer to send output to
     * @param packet packet to format
     */
     ...
     *
     * @param header headercurrently being formatted
     * @param detail detail level to include
     * @throws java.io.IOException any IO errors while sending data to output device
     */
     ...
     *
     * @param count numer of pad strings to pad
     */
     ...
     *
     * @param detail the level of detail to set for all headers
     */
     ...
     *
     * @param detail the level of detail set for this particular header
     * @param id     header id
     */
     ...
     *
     * @param enable if true will include payload header in the display, otherwise it
     *               will not
     ...
     *
     * @param index initial index for frame number
     */
     ...
     *
     * @param out new formatter device
     */
     ...
     *
     * @param enable true to enable address resolution, otherwise false
