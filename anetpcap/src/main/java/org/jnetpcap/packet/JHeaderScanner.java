...
public class JHeaderScanner
     ...
     *
     * @param protocol core protocol constant for which to override its default native
     *                 header scanner
     */
     ...
     *
     * @param packet the packet object this header is bound to
     * @param offset offset into the packet buffer in bytes of the start of this header
     ...
     *
     * @param scan scan state structure that is used to pass around state both in
     ...
     *
     * @param method the new scanner method
     */
