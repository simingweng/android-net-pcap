...
public interface JHeaderAccessor {
     ...
     * data buffer.
     *
     * @param <T>    name of the header
     * @param header instance of a header object
     ...
     * @param <T>      name of the header
     * @param header   instance of a header object
     * @param instance instance number of the header since more than one header of the
     ...
     *
     * @param <T>    name of the header
     * @param index  index into the header array the scanner has found
     * @param header instance of a header object
     ...
     *
     * @param index index into the header array
     ...
     *
     * @param id numerical ID of the header to search for
     ...
     * packet.
     *
     * @param id protocol header ID as assigned by JRegistry
     ...
     *
     * @param id       protocol header ID as assigned by JRegistry
     * @param instance instance number of the specific header within the packet
     * @return true header exists, otherwise false
     */
     ...
     *
     * @param <T>    name of the header type
     * @param header protocol header object instance
     * @return true header exists, otherwise false
     */
