...
public abstract class JHeader
    ...
    public static class State
         ...
         *
         * @param peer destination object holding the native memory reference we need
         *             to peer to
         ...
         *
         * @param flags unsinged integer containing the bit-flags to set for this header
         */
     ...
     *
     * @param id     numerical ID of the protocol
     * @param fields fields usd by the formatter to reformat the packet for output
     * @param name   comprehensive name of the protocol
     */
     ...
     * @param fields  fields usd by the formatter to reformat the packet for output
     * @param name    comprehensive name of the protocol
     * @param nicname a short name for the protocol
     */
     ...
     *
     * @param protocol the CORE protocol constant
     */
     ...
     * Constructs a header and initializes its static fields.
     *
     * @param state   the default header state object being referenced
     * @param fields  fields usd by the formatter to reformat the packet for output
     * @param name    comprehensive name of the protocol
     * @param nicname a short name for the protocol
     */
     ...
     *
     * @param header annotation to initialize from
     */
     ...
     *
     * @param buffer buffer to peer to
     ...
     *
     * @param header the header to peer with this header
     ...
     *
     * @param packet packet to associate with this header
     */
     ...
     *
     * @param headers array of sub header
     */
