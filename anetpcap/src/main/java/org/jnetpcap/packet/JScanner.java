...
public class JScanner extends JStruct {
     ...
     *
     * @param scan a uninitialized JScan object to be used internally by JScanner for
     ...
     * @param id     numerical ID of the data link protocol, or first header within the
     *               data buffer
