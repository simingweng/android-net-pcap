...
public final class JRegistry {
     ...
     * container class.
     *
     * @param bindingContainer container object that contains binding instance methods
     */
     ...
     *
     * @param classes classes of all the headers that java scanner will be cleared if
     ...
     *
     * @param container container object containing scanner methods which target headers
