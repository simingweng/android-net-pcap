 ...
 * {@link #hasHeader(org.jnetpcap.packet.JHeader)} exists that performs both an existance check and
...
public abstract class JPacket extends JBuffer implements JHeaderAccessor {
    ...
    public static class State extends JStruct {
         ...
         * Sizeof.
         *
         * @param count header counter, number of headers to calaculate in
         ...
         * @param buffer source buffer
         * @param offset offset into the buffer
         * @param size   specifies the number of bytes to peer
         * @return number of bytes peered
         */
         ...
         *
         * @param flags bit flags for this packet
         */
         ...
         *
         * @param length the original length of the packet before truncation
         */
     ...
     *
     * @param out new formatter {@link #toString} method. The new formatter will be
     ...
     *
     * @param pool new memory pool to use.
     */
     ...
     * packet.
     *
     * @param size  amount of memory to allocate for packet data
     * @param state size of the state
     */
     ...
     *
     * @param buffer source array buffer to copy data out of
     ...
     *
     * @param minSize minimum number of bytes required for the buffer
     * @return the buffer
     */
     ...
     * @deprecated use static {@link org.jnetpcap.packet.JPacket#getDefaultScanner()} instead
     */
    @Deprecated
     ...
     * offset.
     *
     * @param offset offset into the packet in bytes
     ...
     *
     * @param offset offset of the header to take into account
     ...
     *
     * @param id numerical ID as assigned by JRegistry of the first protocol header
