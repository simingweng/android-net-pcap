...
public class JMemoryPacket
    ...
    public static class JMemoryHeader implements JCaptureHeader {
         ...
         * @param wirelen wire length
         * @param seconds timestamp in seconds
         * @param nanos   nanos fraction of the timestamp
         */
         ...
         * @param wirelen wirelength
         * @param nanos   timestamp fraction in nanos
         * @param seconds timestap in seconds
         */
         ...
         *
         * @param wirelen length on the packet on the network wire
         */
     ...
     * @param buffer buffer containing raw packet data
     */
     ...
     * packet.
     *
     * @param id     ID of the DLT protocol
     * @param buffer buffer containing both state and data in the form
     *               <p/>
     *               <pre>
     *                             +--------------+-------------+
     ...
     *
     * @param id      numerical id of first protocol (DLT)
     * @param hexdump hexdump of the packet contents which will loaded into the raw data
     *                buffer
     */
     ...
     *
     * @param type type of memory model to use
     */
