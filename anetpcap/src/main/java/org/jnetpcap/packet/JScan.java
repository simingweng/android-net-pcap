...
public class JScan
     ...
     *
     * @param prefix  prefix length in bytes before the header
     * @param header  length of the header (same as {@link #scan_length(int)})
     * @param gap     length of the gap between header and payload
     * @param payload length of payload
     * @param postfix length of postfix after the payload
     */
