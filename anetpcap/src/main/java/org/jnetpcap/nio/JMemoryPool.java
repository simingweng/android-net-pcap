...
public class JMemoryPool {
    ...
    public static class Block extends JMemory {
         ...
         *
         * @param size number of bytes to allocate for this block
         */
         ...
         *
         * @param peer memory object to peer with
         */
     ...
     *
     * @param defaultBlockSize minimum memory block allocation size
     */
     ...
     *
     * @param size amount of native memory to allocate in bytes
     ...
     * @param dst destination object to peer with new memory containing copy of
     ...
     *
     * @param src1 first src for duplicate
     * @param src2 second src for duplicate into the same memory
     * @param dst1 peered with new memory using src1 length
     * @param dst2 peered with same memory at src1.length offset using src2 length as
     *             length of peer
     ...
     *
     * @param size minimum available amount of memory in a block
     * @return block big enough to hold size number of bytes
     * {@link org.jnetpcap.nio.JMemoryPool.Block#allocate(int)} the size of memory needed. The block
     ...
     * @see org.jnetpcap.nio.JMemoryPool.Block#allocate(int)
     */
     ...
     *
     * @param atLeastInSize minimum number of bytes to allocate
