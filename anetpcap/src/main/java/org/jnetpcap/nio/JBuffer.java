...
public class JBuffer extends JMemory {
     ...
     *
     * @param index offset into the buffer
     ...
     *
     * @param index offset into the buffer
     * @param array byte array used to store the result where the length of the byte
     ...
     *
     * @param index offset into the buffer
     * @param size  number of bytes to copy and the size of the newly allocated byte
     *              array
     ...
     *
     * @param index  starting position in the JBuffer
     ...
     *
     * @param index     starting offset into the buffer
     * @param delimeter array of chars to search for
     ...
     *
     * @param index     offset into the buffer
     * @param buf       string buffer where to store the string retrieved from the buffer
     * @param delimeter array of chars which will mark the end of the string
     ...
     *
     * @param index  byte index into the buffer to start
     * @param buf    string buffer where the retrieved string is stored
     ...
     *
     * @param index  offset into the buffer
     * @param length number of UTF8 characters to retrieve
     ...
     *
     * @param order the new byte order for this integer
     */
     ...
     *
     * @param peer the buffer to peer with
     * @return number of byte peered
     * @throws PeeringException the peering exception
     */
    @Override
     ...
     * @param offset offset into the new peer buffer
     * @param length number of bytes to peer
     * @return number of bytes peered
     * @throws IndexOutOfBoundsException if offset and/or length are out of bounds
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new value to be stored in the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param array Array containing data to be set within the buffer. The length of
     ...
     *
     * @param index offset into the buffer
     * @param value new double value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new float value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new int value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new long value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new short value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new usigned byte value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new usigned int value to be stored within the buffer
     */
     ...
     *
     * @param index offset into the buffer
     * @param value new unsigned short value to be stored within the buffer
     */
     ...
     *
     * @param buffer Source buffer to copy from. The array length determines the number
     *               of bytes to copy.
     ...
     * Copies contents of the supplied buffer into this buffer.
     *
     * @param src       Source buffer to copy from. The position and limit properties of
     *                  the buffer determine the bounds of the copy.
     * @param dstOffset offset into this buffer where to start the copy
     * @return number of bytes copied
     */
    @Override
     ...
     * Copies contents of the supplied buffer into this buffer.
     *
     * @param buffer Source buffer. The length of the source buffer determines the
     ...
     *
     * @param dst       destination buffer where to copy data to
     * @param srcOffset offset into this buffer where to start the copy
     ...
     *
     * @param dst Destination buffer where to copy to. The number of bytes copied is
     ...
     *
     * @param dst       destination buffer where to copy to
     * @param srcOffset offset into the source buffer where to start copy from
     * @param length    number of bytes to copy
     * @param dstOffset offset into the destination buffer where to start copy to
     * @return number of bytes copied
     */
    @Override
    public int transferTo(final JBuffer dst,
     ...
     *
     * @param readonly buffer accessor mode
     */
     ...
     *
     * @param index offset into this buffer
     * @param data  data to copy into this buffer. The position and limit of the data
     ...
     *
     * @param src source object that holds the memory location and size this object
     *            will point to
