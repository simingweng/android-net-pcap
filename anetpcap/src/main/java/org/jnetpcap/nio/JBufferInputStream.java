...
public class JBufferInputStream
     ...
     * buffer.
     *
     * @param in source buffer to read data out of
     */
     ...
     *
     * @param in     source buffer to read data out of
     * @param offset offset into the source buffer where to start reading
     * @param length number of byte to read out of the buffer before signalining end of
     *               stream
     */
     ...
     *
     * @param b   buffer to store the block of data read
     * @param off offset into the destination buffer where to store the block data
     * @param len number of bytes to read as a block
     * @return the int
     * @throws java.io.IOException Signals that an I/O exception has occurred.
     */
    @Override
     ...
     * Reads a block of data out of the source buffer.
     *
     * @param b Buffer to store the block of data read. The length of read
     ...
     *
     * @param readlimit Maximum number of bytes expected to be read. This parameter is
     ...
     *
     * @param len checks if len bytes are aviable for reading
