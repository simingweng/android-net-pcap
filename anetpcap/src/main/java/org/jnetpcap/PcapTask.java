 ...
 *
 * @param <T> user supplied type {@link #start()} and {@link #stop()}. These 2
...
public abstract class PcapTask<T> implements Runnable {
     ...
     * @param count number of packets to capture or 0 for infinite
     ...
     * </p>
     *
     * @throws InterruptedException since this method waits for the background thread to terminate,
