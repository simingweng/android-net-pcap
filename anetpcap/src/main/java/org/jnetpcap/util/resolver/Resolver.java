...
public interface Resolver {
     ...
     *
     * @param address address to check mapping for
     ...
     * the load fails.
     *
     * @param url URL of the resource containing the database to load
     ...
     *
     * @param address address to try and resolve
     ...
     * @throws java.io.IOException any IO errors during save
     */
