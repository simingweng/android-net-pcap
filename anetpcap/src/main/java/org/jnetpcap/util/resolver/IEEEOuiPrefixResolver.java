...
public class IEEEOuiPrefixResolver extends AbstractResolver {
     ...
     * <p/>
     *
     * @param url The url of the IEEE resource to load. If the url is null, the
     ...
     * @param more     the more
     * @param singular term to look for in sigular form
     * @param abbr     abbreviation to substitute in place
     * @return new string
     */
