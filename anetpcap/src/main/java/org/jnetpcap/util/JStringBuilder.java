...
public class JStringBuilder implements Appendable {
     ...
     *
     * @return the int
     * @see AbstractStringBuilder#capacity()
     */
    public int capacity() {
     ...
     * @return the char
     * @see AbstractStringBuilder#charAt(int)
     */
     ...
     * @param index the index
     * @return the int
     * @see AbstractStringBuilder#codePointAt(int)
     */
     ...
     * @param index the index
     * @return the int
     * @see AbstractStringBuilder#codePointBefore(int)
     */
     ...
     * @return the int
     * @see AbstractStringBuilder#codePointCount(int, int)
     */
     ...
     * @see AbstractStringBuilder#ensureCapacity(int)
     */
     ...
     * @see AbstractStringBuilder#getChars(int, int, char[], int)
     */
     ...
     * @return the int
     * @see AbstractStringBuilder#offsetByCodePoints(int, int)
     */
     ...
     * @param index the index
     * @param ch    the ch
     * @see AbstractStringBuilder#setCharAt(int, char)
     */
     ...
     * @see AbstractStringBuilder#subSequence(int, int)
     */
     ...
     * @param start the start
     * @return the string
     * @see AbstractStringBuilder#substring(int)
     */
     ...
     * @param end   the end
     * @return the string
     * @see AbstractStringBuilder#substring(int, int)
     */
     ...
     * Trim to size.
     *
     * @see AbstractStringBuilder#trimToSize()
     */
