...
public class JConfig {
    ...
    protected static class ClasspathSearch implements SearchPath {
         ...
         * @see org.jnetpcap.util.config.JConfig.SearchPath#getFile(String)
         */
         ...
         * @throws java.io.IOException Signals that an I/O exception has occurred.
         * @see org.jnetpcap.util.config.JConfig.SearchPath#getInputStream(String)
         */
         ...
         * @return the uRL
         * @throws java.io.IOException Signals that an I/O exception has occurred.
         * @see org.jnetpcap.util.config.JConfig.SearchPath#getURL(String)
         */
         ...
         * @param name the name
         * @return the dir
         * @see org.jnetpcap.util.config.JConfig.SearchPath#getDir(String)
         */
    ...
    private static class CompositeProperties
         ...
         * @param in the in
         * @throws java.io.IOException                        Signals that an I/O exception has occurred.
         * @throws java.util.InvalidPropertiesFormatException the invalid properties format exception
         * @see java.util.Properties#loadFromXML(java.io.InputStream)
         */
        @Override
         ...
         *
         * @param userProperties the new save properties
         */
