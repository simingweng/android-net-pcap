...
public class Checksum {
     ...
     *
     * @param buffer buffer to calculate crc on
     * @param offset offset into the buffer
     * @param length length within the buffer
     ...
     * @param offset offset into the buffer
     * @param length length within the buffer
     * @param crc    the preload value for the CRC16 computation
     * @return calculated crc
     */
     ...
     * @param offset offset into the buffer
     * @param length length within the buffer
     * @param crc    the preload value for the CRC32 computation
     * @return calculated crc
     */
     ...
     *
     * @param buffer buffer to calculate for
     * @param offset offset into the buffer in bytes
     * @param length number of bytes to run calculation on
     ...
     * @param ipOffset   the ip offset
     * @param icmpOffset the icmp offset
     * @return the int
     */
     ...
     *
     * @param buffer buffer to reach the chunk of data
     * @param offset offset into the buffer
     ...
     *
     * @param checksum          checksum within the header's field
     * @param calculateChecksum checksum that was calculated
     ...
     * @param buffer    the buffer
     * @param ipOffset  the ip offset
     * @param tcpOffset the tcp offset
     * @return the int
     */
     ...
     * @param buffer    the buffer
     * @param ipOffset  the ip offset
     * @param udpOffset the udp offset
     * @return the int
     */
