...
public abstract class BlockingQueuePump<T> implements BlockingQueue<T> {
     ...
     *
     * @param name name to use for the worker thread
     */
     ...
     *
     * @param name     name to use for the workder thread
     ...
     * @see java.util.concurrent.BlockingQueue#add(Object)
     */
     ...
     * @see java.util.concurrent.BlockingQueue#offer(Object, long,
