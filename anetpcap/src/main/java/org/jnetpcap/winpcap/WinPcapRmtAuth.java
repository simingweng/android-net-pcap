...
public final class WinPcapRmtAuth {
     ...
     *
     * @param type     authentication type; values of 0 or 1 permitted
     * @param username string containing the username that has to be used on the remote
     *                 machine for authentication
     * @param password string containing the password that has to be used on the remote
     *                 machine for authentication
     */
