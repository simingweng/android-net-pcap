...
public class WinPcapSendQueue extends JStruct {
     ...
     *
     * @param data data to be copied into the queue
     */
     ...
     * </p>
     *
     * @param buffer a direct buffer containing the data to be send
     * @throws org.jnetpcap.packet.PeeringException the peering exception
     */
     ...
     * network interface.
     *
     * @param header all fields need to be initialized as they are all used
     * @param data   Buffer containing packet data. The buffer's position and limit
     ...
     * network interface.
     *
     * @param hdr  all fields need to be initialized as they are all used
     * @param data Buffer containing packet data. The length of the data must much
     ...
     *
     * @param len current size of the queue, in bytes
     */
