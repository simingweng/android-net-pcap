...
public class PcapHeader
     ...
     *
     * @param type memory allocation model type
     */
     ...
     *
     * @param len new value for hdr_len field
     */
     ...
     *
     * @param ts new value for hdr_sec field
     */
     ...
     *
     * @param ts new value for hdr_usec field
     */
     ...
     *
     * @param len new value for hdr_wirelen field
     */
     ...
     *
     * @param memory object to peer with this header
     * @param offset offset into memory object
     ...
     *
     * @param header header to peer with
     * @param offset offset into the supplied header
     * @return number of bytes peered
     */
