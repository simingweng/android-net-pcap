...
public class PcapBpfProgram {
     ...
     *
     * @see org.jnetpcap.Pcap#compile(org.jnetpcap.PcapBpfProgram, String, int, int)
     * @see org.jnetpcap.Pcap#compileNoPcap(int, int, org.jnetpcap.PcapBpfProgram, String, int, int)
     */
     ...
     * supplied buffer.
     *
     * @param instructions buffer containing BPF instructions
     * @since 1.2
     */
     ...
     * and makes a copy.
     *
     * @param array bpf instruction array
     */
     ...
     *
     * @param buffer bpf instruction buffer
     */
