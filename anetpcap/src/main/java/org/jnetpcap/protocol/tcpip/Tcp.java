...
public class Tcp extends JHeaderMap<Tcp> implements JHeaderChecksum {
    ...
    public static class AlternateChecksum extends TcpOption {
         ...
         * is determined on a checksum by checksum basis.
         *
         * @param array copies data into the supplied array
    ...
    public enum Flag {
         ...
         *
         * @param flags integer containing the flags (8-bits)
         ...
         * within the integer.
         *
         * @param flags integer containing the flags (8-bit)
         ...
         * collection's set.
         *
         * @param flags a collection's set of flags
         * @return a terse representation of the flags
         */
    ...
    public static class SACK extends TcpOption {
         ...
         * value there.
         *
         * @param array array containing the block records
         */
         ...
         * sequence numbers past the last acked byte in the stream.
         *
         * @param array preallocated array to store the data
    ...
    public static abstract class TcpOption extends JSubHeader<Tcp> {
        ...
        public enum OptionCode {
             ...
             *
             * @param id numerical constant to convert
         ...
         *
         * @param value new numerical code for this field
         */
         ...
         *
         * @param value new length in bytes to be stored in length field
         */
     ...
     *
     * @param buffer buffer containing packet and/or tcp header data
     * @param offset offset into the buffer where tcp header start (in bytes)
     ...
     *
     * @param value sets the flag bit, false clears it
     */
