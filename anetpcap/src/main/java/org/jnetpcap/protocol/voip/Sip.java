...
public class Sip
    ...
    public enum Code {
         ...
         *
         * @param code numerical code value
         ...
         *
         * @param code string containing iteger value
    ...
    public enum ContentType {
         ...
         *
         * @param type string containing content type
     ...
     *
     * @param line the line
     * @see org.jnetpcap.packet.AbstractMessageHeader#decodeFirstLine(String)
     */
    @Override
