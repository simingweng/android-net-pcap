...
public class Rtp extends JHeader {
    ...
    public abstract static class Extension extends JSubHeader<Rtp> {
         ...
         * @param offset offset within the buffer of the start of the header
    ...
    public enum PayloadType {
         ...
         *
         * @param type value of the payload field
     ...
     *
     * @param buffer buffer with rtp header
     ...
     * header.
     *
     * @param buffer buffer to read options and padding information from
     * @param offset offset to the start of the header
