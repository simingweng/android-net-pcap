...
public final class PcapUtils {
     ...
     * @param pcap    an open pcap object
     * @param cnt     number of packets to capture and exit, 0 for infinate
     * @param handler user supplied callback handler
     * @param data    opaque, user supplied data object dispatched back to the handler
     ...
     *
     * @param netif network device as retrieved from Pcap.findAllDevs().
     * @return network interface hardware address or null if unable to retrieve it
     * @throws java.io.IOException any communication errors
     * @see org.jnetpcap.Pcap#findAllDevs(java.util.List, StringBuilder)
     */
     ...
     *
     * @param <T>     user supplied type
     * @param cnt     number of packets
     * @param id      dlt type
     * @param handler user packet handler
     * @param user    user object
     * @param packet  packet used for peering when using no copy mode
     ...
     * @param cnt     the cnt
     * @param id      the id
     * @param handler handler to dispatch the injected packet to
     * @param user    user data
     * @param packet  packet to inject into the loop and callback
     * @param state   the state
     * @param header  pcap header for this packet
